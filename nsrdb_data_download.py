...
BASE_URL_2021 = "https://developer.nrel.gov/api/nsrdb/v2/solar/full-disc-download.csv?"
POINTS = [
'814062'
]
...
def main():
    input_data = {
        'attributes': 'dni,wind_speed,relative_humidity,air_temperature,surface_pressure',
        'interval': '60',
        'to_utc': 'false',
        'half_hour': 'true',
    ...
    for name in ['2011','2012','2013','2014','2015','2016','2017','2018','2019','2020', '2021']:
        ...
        for id, location_ids in enumerate(POINTS):
            ...
            if '.csv' in BASE_URL:
                if name == "2021":
                    url = BASE_URL_2021 + urllib.parse.urlencode(input_data, True)
                else:
